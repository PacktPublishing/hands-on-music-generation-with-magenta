...
- [**Magenta v2.0.1** (in the `magenta-2.0.1` branch)](https://github.com/PacktPublishing/hands-on-music-generation-with-magenta/tree/magenta-2.0.1) - We also provide the code for newer versions of Magenta, like Magenta 2.0.1 which is latest version we have the code for.
